...
parser.add_argument('--task', 
                  choices=['dil_task_0', 'dil_task_1' , 'dil_task_2', 'dil_task_3' , 'dil_joint',
                           'cil_task_0', 'cil_task_1', 'cil_task_2', 'cil_task_3', 'cil_joint', 'cil_debug'
                           ], 
                  default='dil_task_0',
                  required=True,
...
parser.add_argument('--early_stop', action='store_true', help="Enable pretrain.")
parser.add_argument('--background_volume', type=int, help="Set background volume.")
parser.add_argument('--epochs', type=int, help="Set background volume.")
...
if args.task == 'dil_task_0' or args.task == 'dil_task_1' or \
   args.task == 'dil_task_2' or args.task == 'dil_task_3' or args.task == 'dil_joint' or args.task == 'cil_joint':
  n_classes = config['n_classes'] + 2 # 35 words + 1 unknown + 1 silence

elif (args.task == 'cil_task_0' or args.task == 'cil_task_1' or \
   args.task == 'cil_task_2' or args.task == 'cil_task_3') and args.method == 'source_only':
  n_classes = 19
...
if pre_train:
  ...
  if args.method == 'source_only':
    ...
    if args.method == 'finetune':
      training_environment.finetune(model)
